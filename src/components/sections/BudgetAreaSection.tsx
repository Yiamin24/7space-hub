...
export default function BudgetAreaSection() {
  ...
  return (
    <section id="budget-area" className="py-12 lg:py-16 bg-slate-900 text-white">
      <div className="mx-auto max-w-[120rem] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:gap-16 lg:grid-cols-2 items-start">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-heading text-2xl font-bold">Budget Range</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {budgetRanges.map((item, i) => (
                  ...
                  >
                    <div className="font-bold text-lg text-primary">{item.label}</div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-heading text-2xl font-bold">Carpet Area Range</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Button
              ...
              className="w-full bg-primary text-white hover:bg-primary/90 shadow-lg mt-4"
              size="lg"
            >
              Get Best Options
          ...
          >
            <div>
              <h3 className="font-heading text-2xl font-bold mb-4">Lead Weightage System</h3>
              <p className="font-paragraph text-gray-300 leading-relaxed mb-8">
              ...
              {priorityRules.map((rule, i) => (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <div className="font-bold text-lg text-white">{rule.range}</div>
                      <div className="text-sm text-gray-400">{rule.desc}</div>
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-heading font-bold text-primary">{rule.priority}%</div>
            ...
            <div className="bg-primary/10 border border-primary/30 rounded-lg p-6 mt-8">
              <div className="font-bold text-white mb-2">Overall Requirement Range</div>
              <div className="text-2xl font-heading font-bold text-primary">350 - 3000 sq.ft</div>
              <div className="text-sm text-gray-300 mt-2">Comprehensive coverage for all business sizes</div>
            </div>
          </motion.div>
        </div>
      </div>
